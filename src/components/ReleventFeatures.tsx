    ...
    <section className="container mx-auto px-4 py-12 flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <p className="text-gray-600 mt-4">
          Our Note & Nest store of stationery and creative
          essentials! We are ready to impress you with an enormous selection of
          the finest notebooks, pens, art supplies, office essentials, and
          personalized stationery to stir up your creativity and provide the
          best organization.
        </p>
